    ...
    <article className="bio-text prose max-w-[65rem] lg:max-w-none mx-auto lg:mx-0 h-auto min-h-0">
     ...
     <FadeIn><p>Earlier that year, my maternal grandfather had just passed away. He had been an architecture professor at the university in the town where I grew up. He was a <i>professor</i> in the deep and literal sense of the word. He professed the gospel of reason and logic. He taught me how to think. So, with his passing, something greatly changed in me: I had to be my own grandfather. I had to keep alive, from him, what was most vital to me: my creativity, my sense of wanting to construct.</p></FadeIn>
        ...
        <div className="lg:mt-10">
          <FadeIn><p className="first-big which-brings">Which brings us to the present day...</p></FadeIn>
          ...
          <FadeIn><p>There is nothing that I enjoy more than writing music, building structures out of sound. Writing music for me has a strong resonance with the mythic past. It connects me by drawing a line directly from me to my ancestors who lived on the land. They walked on the ground, bare-footed. It is the story of these places and people that finds a home in my work.</p></FadeIn>

          <FadeIn delay={100}><p>I hold a Bachelors in Music Composition, with a minor in German Language and Literature, and Masters in Information Science, both from Louisiana State University. I will be pursuing a Masters in Music Composition at Louisiana State University in the Fall of 2026.</p></FadeIn>
        </div>
